    ...
    <>
      ...
      <section id="About Me" class="aboutmesections">
        <div class="contentspace">
          <img class="mainimage" id="aboutmecontent" src="src/assets/pro_pick.jpg" />
          <div class="text">
            <hr class="sep" />
            <h1>
              About Me
            ...
            <div class="underaboutme">
              <div class="timelineright">
                ...
                <Event date="Now" desc="Continuing education in front-end and back-end development"></Event>
              </div>
              <div class="timelineleft">
                <p>-/ My Knowledge /-</p>
                <Know icon="src/assets/lenguage icons/icons8-html-5.svg" desc="Html"></Know>
                <Know icon="src/assets/lenguage icons/icons8-css3.svg" desc="Css"></Know>
                <Know icon="src/assets/lenguage icons/icons8-javascript-logo.svg" desc="JavaScript"></Know>
                <Know icon="src/assets/lenguage icons/react.png" desc="React"></Know>
                <Know icon="src/assets/lenguage icons/nodejs-icon.jpg" desc="Node.js"></Know>
                <Know icon="src/assets/lenguage icons/icons8-python.svg" desc="Pyhton"></Know>
                <Know icon="src/assets/lenguage icons/icons8-java.svg" desc="Java"></Know>
                <Know icon="src/assets/lenguage icons/icons8-.net-framework.svg" desc=".Net FrameWork"></Know>
              </div>
            </div>
          </div>
        </div>
